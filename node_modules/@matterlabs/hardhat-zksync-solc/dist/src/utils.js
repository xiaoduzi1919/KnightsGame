...
exports.getZkVmNormalizedVersion = exports.saveDataToFile = exports.getLatestRelease = exports.download = exports.writeLibrariesToFile = exports.mapMissingLibraryDependencies = exports.findMissingLibraries = exports.generateSolcJSExecutableCode = exports.isVersionInRange = exports.getVersionComponents = exports.pluralize = exports.getZkVmSolcUrl = exports.getZksolcUrl = exports.saltFromUrl = exports.sha1 = exports.isURL = exports.zeroxlify = exports.updateCompilerConf = exports.filterSupportedOutputSelections = void 0;
...
function updateCompilerConf(solcConfigData, zksolc, userConfigCompilers) {
    ...
    if (compiler.eraVersion && semver_1.default.lt(zksolc.version, constants_1.ZKSOLC_COMPILER_VERSION_MIN_VERSION_WITH_ZKVM_COMPILER)) {
        throw new errors_1.ZkSyncSolcPluginError(constants_1.COMPILER_ZKSOLC_VERSION_WITH_ZKVM_SOLC_ERROR);
    }
}
