...
export declare const COMPILER_ZKSOLC_VERSION_WITH_ZKVM_SOLC_ERROR = "zkVm (eraVersion) compiler is supported only with usage of zksolc version >= 1.3.22.";
...
export declare const COMPILE_AND_DEPLOY_LIBRARIES_INSTRUCTIONS = "To compile and deploy libraries, please run: `yarn hardhat deploy-zksync:libraries`";
