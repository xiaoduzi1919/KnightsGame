...
export declare function updateCompilerConf(solcConfigData: SolcConfigData, zksolc: ZkSolcConfig, userConfigCompilers: SolcUserConfig[] | Map<string, SolcUserConfig>): void;
...
export declare function getZkVmSolcUrl(repo: string, version: string, isRelease?: boolean): string;
...
export declare function getLatestRelease(owner: string, repo: string, userAgent: string, tagPrefix?: string, timeout?: number): Promise<any>;
