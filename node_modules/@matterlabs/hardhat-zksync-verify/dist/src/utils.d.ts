...
export declare function normalizeCompilerVersions(solcConfigData: SolcConfigData, userConfigCompilers: SolcUserConfig[] | Map<string, SolcUserConfig>): string | undefined;
